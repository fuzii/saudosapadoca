...
public class AddEstablishmentServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try{
			...
			establishment.setResponsibleName(request.getParameter("responsibleName"));
			establishment.setResponsibleEmail(request.getParameter("responsibleEmail"));
			establishment.setResponsiblePhone(request.getParameter("responsiblePhone"));
