				...
				<div class="panel-body">
					<form method="post" action="login" class="form">
						<div class="form-group">
							<input type="text" class="form-control form-group" name="login" placeholder="email" />
							<input type="password" class="form-control form-group" name="password" placeholder="senha" />
